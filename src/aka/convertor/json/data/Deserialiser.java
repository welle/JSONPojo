...
public class Deserialiser {
	...
	private final Map<@NonNull String, aka.convertor.json.data.DeserialiseItem> deserialiseItemMap = new HashMap<>();
	...
	@NonNull
	public List<aka.convertor.json.data.DeserialiseItem> getItems() {
