 ...
 * @author Welle
 */
public final class Example3JacksonMapper {
     ...
     */
    @Nullable
    public static Example3 readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        Example3 result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, Example3.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final Example3 object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
