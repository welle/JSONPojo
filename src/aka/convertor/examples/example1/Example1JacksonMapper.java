...
public final class Example1JacksonMapper {
     ...
     */
    @Nullable
    public static Example1 readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        Example1 result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, Example1.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final Example1 object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
